...
const copy = {
  ...
  en: {
    ...
    androidInstallSteps: ["Download the evaluation APK using this page’s download button on an Android phone, then open the downloaded file.", "Temporarily allow installation from your browser or file manager when Android asks, then install the app.", "Open 3ialna, create a parent PIN, and enable biometrics where available.", "Define the children using the shared device, choose the active child, select an age profile, then review social, games, sleep, and prayer settings.", "In Child tasks and reminders, record a parent voice note and choose every hour or every two hours. The notification opens 3ialna to play the note locally; it does not autoplay in the background.", "Grant Usage Access, Accessibility, and Overlay. Enable Device Admin only if you want to attempt hard lock; the visual blocker remains the fallback when it is unavailable.", "Categorize installed apps, then review the category rules before handing the device to a child."],
